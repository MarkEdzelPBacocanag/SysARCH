                        ...
                        <td>
                            <?php if ($row['status'] === 'pending'): ?>
                                <form method="POST" style="display:inline-flex; gap:5px;">
                                    ...
                                    <button type="submit" name="action" value="accept" class="post-btn" style="margin-top: 0;">Accept</button>
                                    <button type="submit" name="action" value="decline" class="btn btn-danger" style="height: auto;">Decline</button>
                                </form>
                            <?php else: ?>
