<?php
session_start();
// retrieve validation errors and previous values then clear them
        ...
        <div class="registerform">
            ...
            <div class="pass" style="display: inline-flex; flex-direction: column; gap: 0.5rem;">
                <div style="display: flex; justify-content: space-between;">
                    ...
                    <div class="field-group" style="flex:1;">
                        <label for="confirm-password" style="margin-right: 11rem;">Confirm password: </label>
            ...
            <div style="display: inline-flex; flex-direction: row; gap: 5px;">
                <div>
                    <button type="button" style="background-color: #dc3545; color: #ffffff;" onclick="window.location.href='index.php';">Back</button>
                </div>  
                <div>        
