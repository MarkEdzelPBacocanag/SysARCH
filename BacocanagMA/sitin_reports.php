...
<head>
    ...
    <style>
        .filter-form { display: flex; gap: 1rem; background: white; padding: 1rem; margin-bottom: 1rem; align-items: flex-end; }
        .filter-group { display: flex; flex-direction: column; }
    </style>
</head>
<body>
    <div class="container-nav">
        <div style="padding-left: 3rem;"><h2>Sit-in Reports</h2></div>
        <div class="link-ref">
